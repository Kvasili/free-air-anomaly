...
function fl2EDMGRS(f1,l1){
	...
	var lenxxxx=xxxx.toString().length;
	var lenyyyy=yyyy.toString().length;
	//console.log(xxxx.toString().length);
	//console.log(yyyy.toString().length);
	...
	{
      out[4]='0'+xxxx.toString();
	}
	else if(lenxxxx==3)
	{
		out[4]='00'+xxxx.toString();
	}
	else if(lenxxxx==2)
	{
		out[4]='000'+xxxx.toString();
	}
	else if(lenxxxx==1)
	{
		out[4]='0000'+xxxx.toString();
	}
	else{
		out[4]=xxxx.toString();
	...
	{
      out[5]='0'+yyyy.toString();
	}
	else if(lenyyyy==3)
	{
		out[5]='00'+yyyy.toString();
	}
	else if(lenyyyy==2)
	{
		out[5]='000'+yyyy.toString();
	}
	else if(lenyyyy==1)
	{
		out[5]='0000'+yyyy.toString();
	}
	else{
		out[5]=yyyy.toString();
...
function kan100(){
	...
	for(j=x0-5;j<=x0+5;j++){
				...
				if (j==x0+5){		ar4=new google.maps.LatLng(a4[0],a4[1]);
							coors=[ar3,ar1,ar2,ar4,ar3];
				}else if(i==y0+5){	ar4=new google.maps.LatLng(a4[0],a4[1]);
							coors=[ar3,ar1,ar2,ar4,ar3];
				}else{			coors=[ar3,ar1,ar2];
				}
...
//alert(y100);
	...
	for(i = 1;i<10;i++){
		...
		//alert(UTM2[8]);
		//alert(UTM2[9]);
		if(UTM2[8]==z2 && UTM2[9]==z1){
			//alert(i);
			y100=tempy100;i=2000;}
	}
